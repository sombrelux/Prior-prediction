...
generated quantities{
  ...
  mu_sloc = trunc_normal_rng(5,5,0,positive_infinity());
  mu_scol = trunc_normal_rng(5,5,0,positive_infinity());
  mu_kappa = trunc_normal_rng(7,5,0,positive_infinity());
  ...
  for(i in 1:nPart){
    ...
    sloc[i] = trunc_normal_rng(mu_sloc,5,0,positive_infinity());
    scol[i] = trunc_normal_rng(mu_scol,5,0,positive_infinity());
    kappa[i] = trunc_normal_rng(mu_kappa,5,0,positive_infinity());
