...
generated quantities{
  ...
  //informative priors  
  for(i in 1:nPart){
    a[i] = trunc_normal_rng(0,0.3,0,positive_infinity());
    b[i] = trunc_normal_rng(0,0.3,0,positive_infinity());
    r[i] = trunc_normal_rng(0,0.3,0,1);
    sloc[i] = trunc_normal_rng(5,10,0,positive_infinity());
    scol[i] = trunc_normal_rng(5,10,0,positive_infinity());
    kappa[i] = trunc_normal_rng(7,10,0,positive_infinity());
    delta[i] = trunc_normal_rng(20,10,0,positive_infinity());
    w[i] = trunc_normal_rng(1,0.3,0,1);
  }
