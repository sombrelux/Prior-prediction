...
ggsave(paste0('./VWM/output/fig/results/resp_err_',i,'.png'),
       height=4, width = 8)
...
ggsave(paste0('./VWM/output/fig/results/nt_resp_',i,'.png'),
       height=4, width = 4)
...
ggplot(dloc_dp,aes(x=dist))+
  ...
  theme(axis.text=element_text(size=12),
        ...
        strip.text.x = element_text(size = 12),
        legend.position = 'none')
ggsave(paste0('./VWM/output/fig/results/dloc_',i,'.png'),
       height=4, width = 8)
...
ggsave(paste0('./VWM/output/fig/results/dcol_',i,'.png'),
       height=4, width = 8)
