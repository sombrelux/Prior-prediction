...
generated quantities{
  ...
  //informative priors
  a = trunc_normal_rng(0.15,0.3,0,positive_infinity());
  b = trunc_normal_rng(0.14,0.45,0,positive_infinity());
  r = trunc_normal_rng(0,0.51,0,1);
  sloc = trunc_normal_rng(5.6,17.1,0,positive_infinity());
  scol = trunc_normal_rng(3,3,0,positive_infinity());
  kappa = trunc_normal_rng(6.6,3,0,positive_infinity());
  delta = trunc_normal_rng(19.7,9,0,positive_infinity());
  w = beta_rng(3,2);
