...
generated quantities{
  ...
  //individual parameters
  a = trunc_normal_rng(0,0.5,0,1);
  b = trunc_normal_rng(0,0.5,0,1);
  r = beta_rng(1,2);
  s = trunc_normal_rng(100,30,0,positive_infinity());
  kappa = trunc_normal_rng(10,3,0,positive_infinity());
  kappaf = trunc_normal_rng(40,10,0,positive_infinity());
