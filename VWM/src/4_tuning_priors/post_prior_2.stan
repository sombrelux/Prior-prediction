...
generated quantities{
  ...
  //individual parameters
  a = trunc_normal_rng(0,0.2,0,1);
  b = trunc_normal_rng(0,0.2,0,1);
  r = beta_rng(1,4);
  s = trunc_normal_rng(100,30,0,positive_infinity());
  kappa = trunc_normal_rng(9,3,0,positive_infinity());
  delta = trunc_normal_rng(30,10,0,positive_infinity());
