...
generated quantities{
  ...
  //informative priors
  a = trunc_normal_rng(0,0.1,0,positive_infinity());
  b = trunc_normal_rng(0,0.1,0,positive_infinity());
  r = trunc_normal_rng(0,0.1,0,1);
  sloc = trunc_normal_rng(5,5,0,positive_infinity());
  scol = trunc_normal_rng(5,5,0,positive_infinity());
  kappa = trunc_normal_rng(7,5,0,positive_infinity());
  delta = trunc_normal_rng(20,5,0,positive_infinity());
  w = trunc_normal_rng(1,0.1,0,1);
