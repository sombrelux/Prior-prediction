...
i=1;sig_s=1;a_w=1;b_w=1;mu_s=5
...
samples <- stan(
  file = './VWM/src/4_prior_pred_ind/prior_IM.stan',
  data = data, 
  pars = parameters,
  iter = 1000,
  warmup = 0,
...
write.table(ypred,
            file = paste0("./VWM/output/results/prior_pred_ind/IM_",
...
ypred <- read.table(paste0("./VWM/output/results/prior_pred_ind/IM_",
                           i,"_",sig_s,"_",a_w,"_",b_w,".txt"),
                    header = TRUE)
