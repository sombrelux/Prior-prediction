...
generated quantities{
  ...
  r = trunc_normal_rng(0,0.3,0,1);
  sloc = trunc_normal_rng(5,10,0,positive_infinity());
  scol = trunc_normal_rng(5,10,0,positive_infinity());
  kappa = trunc_normal_rng(7,10,0,positive_infinity());
  delta = trunc_normal_rng(20,10,0,positive_infinity());
  w = trunc_normal_rng(1,0.3,0,1);
