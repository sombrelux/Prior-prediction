...
generated quantities{
  ...
  for(k in 1:nPart){
    beta_xo[k] = trunc_normal_rng(1,0.5,0,positive_infinity());
    beta_to[k] = trunc_normal_rng(0.2,0.3,0,positive_infinity());
    beta_po[k] = trunc_normal_rng(1.5,0.5,0,positive_infinity());
    
    beta_xa[k] = trunc_normal_rng(0,0.003,0,positive_infinity());
    beta_xr[k] = trunc_normal_rng(0.9,0.5,0,positive_infinity());
    beta_pa[k] = trunc_normal_rng(1,1,0,positive_infinity());
    beta_pr[k] = trunc_normal_rng(1,1,0,positive_infinity());
    beta_ta[k] = trunc_normal_rng(0.04,0.02,0,positive_infinity());
    beta_tr[k] = trunc_normal_rng(0.1,0.2,0,positive_infinity());
