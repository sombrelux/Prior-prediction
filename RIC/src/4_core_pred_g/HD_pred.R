...
for(i in c(1,5,10,50,100)){
  data<-list(
	...
	saveRDS(samples,paste0('./RIC/output/results/core_pred_g/prior_HD_normal_',i,'.rds'))
}
...
for(i in c(1,5,10,50,100)){
  ...
  write_csv(hdi_hd,paste0('./RIC/output/results/core_pred_g/hdi_HD_normal_',i,'.csv'))
}
