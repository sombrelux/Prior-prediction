...
for(i in 1:5){
  ...
  saveRDS(samples,
          paste0('./RIC/output/results/core_pred_unfit/prior_RITCH_normal_',i,'.rds')) 
}
...
write_csv(hdi_ritch,paste0('./RIC/output/results/core_pred_unfit/hdi_RITCH_normal_',i,'.csv'))
