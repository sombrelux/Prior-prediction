...
for(i in c(10)){
  data<-list(
    ...
    mu_a = 0, mu_logh = 0, mu_i = mu_post[3], mu_s = mu_post[4],
    sig_a = i, sig_logh = i, sig_i = sig_post[3]*i, sig_s = sig_post[4]*i)
	...
	saveRDS(samples,paste0('./RIC/output/results/core_pred_ind/prior_HD_normal_',i,'.rds'))
}
