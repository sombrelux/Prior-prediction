...
generated quantities{
  ...
  for(k in 1:nPart){
    alpha[k] = trunc_normal_rng(0.2,0.03,10^(-5),positive_infinity());
    beta[k] = trunc_normal_rng(0.59,0.04,negative_infinity(),1);
    gamma[k] = trunc_normal_rng(0.54,0.06,0,1);
    R[k] = trunc_normal_rng(10.5,1.5,0,positive_infinity());
    s[k] = trunc_normal_rng(2.8,0.4,0,positive_infinity());
