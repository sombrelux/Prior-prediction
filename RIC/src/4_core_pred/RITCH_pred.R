...
samples <- readRDS('./RIC/output/results/core_pred/prior_RITCH_origin.rds')
...
write_csv(hdi_hd,'./RIC/output/results/core_pred/hdi_RITCH_origin.csv')
...
write_csv(hdi_eff_ritch,
          paste0('./RIC/output/results/core_pred/hdi_ritch_uniform_',i,'.csv'))
