...
generated quantities{
  ...
  for(k in 1:nPart){
    beta_xo[k] = trunc_normal_rng(1,1,0,positive_infinity());
    beta_to[k] = trunc_normal_rng(1,1,0,positive_infinity());
    beta_po[k] = trunc_normal_rng(1,1,0,positive_infinity());
    
    beta_xa[k] = trunc_normal_rng(0.1,1,0,positive_infinity());
    ...
    beta_ta[k] = trunc_normal_rng(0.5,1,0,positive_infinity());
    beta_tr[k] = trunc_normal_rng(0.5,1,0,positive_infinity());
