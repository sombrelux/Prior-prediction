...
generated quantities{
  ...
  for(k in 1:nPart){
    beta_xo[k] = trunc_normal_rng(0.05,0.03,0,positive_infinity());
    beta_to[k] = trunc_normal_rng(0.05,0.03,0,positive_infinity());
    beta_po[k] = trunc_normal_rng(0.3,0.1,0,positive_infinity());
    
    beta_xa[k] = trunc_normal_rng(0.0002,0.00008,0,positive_infinity());
    beta_xr[k] = trunc_normal_rng(0.3,0.2,0,positive_infinity());
    beta_pa[k] = trunc_normal_rng(3,0.1,0,positive_infinity());
    beta_pr[k] = trunc_normal_rng(0.3,0.4,0,positive_infinity());
    beta_ta[k] = trunc_normal_rng(0.02,0.005,0,positive_infinity());
    beta_tr[k] = trunc_normal_rng(0.07,0.03,0,positive_infinity());
