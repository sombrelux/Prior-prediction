...
generated quantities{
  ...
  for(k in 1:nPart){
    beta_xo[k] = trunc_normal_rng(0,100,0,positive_infinity());
    beta_to[k] = trunc_normal_rng(0,100,0,positive_infinity());
    beta_po[k] = trunc_normal_rng(0,100,0,positive_infinity());
    //beta_xp[k] = normal_rng(0,sig_beta_xp);//beta_xp[k] = trunc_normal_rng(mu_beta_xp,sig_beta_xp,0,positive_infinity());
    //beta_xt[k] = normal_rng(0,sig_beta_xt);//beta_xt[k] = trunc_normal_rng(mu_beta_xt,sig_beta_xt,0,positive_infinity());
    beta_xa[k] = trunc_normal_rng(0,100,0,positive_infinity());
    beta_xr[k] = trunc_normal_rng(0,100,0,positive_infinity());
    beta_pa[k] = trunc_normal_rng(0,100,0,positive_infinity());
    beta_pr[k] = trunc_normal_rng(0,100,0,positive_infinity());
    beta_ta[k] = trunc_normal_rng(0,100,0,positive_infinity());
    beta_tr[k] = trunc_normal_rng(0,100,0,positive_infinity());
